      ...
      <div className="container mx-auto my-auto px-4 sm:px-0 py-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {contents.map((item: any, idx: number) => (
            <div key={idx}>
              <div className="text-gray-500 dark:text-white font-normal text-sm">
                {item.about}
              </div>
            </div>
          ))}
...
const contents = [
  {
    about: (
      <div
        data-aos="fade-left"
        className="hover:animate-pulse  p-4 -black  rounded-lg"
      >
  ...
  },
  {
    about: (
      <div
        data-aos="fade-left"
        data-aos-delay="400"
        className="hover:animate-pulse  -gr p-4  text-black  rounded-lg"
      >
  ...
  },
  {
    about: (
      <div
        data-aos="fade-left"
        data-aos-delay="600"
        className="hover:animate-pulse  p-4 text-black  rounded-lg"
      >
